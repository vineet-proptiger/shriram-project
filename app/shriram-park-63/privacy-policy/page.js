...
import { logoImages } from "../../../lib/shriram-park-63/images";
import AosInit from "../../../components/shriram-park-63/AosInit";
    ...
    <main className="min-h-screen bg-white">
      ...
      >
        ...
        <div className="container mx-auto px-4 md:px-8 flex items-center justify-between h-[80px]">
          <Link href="/shriram-park-63" className="flex items-center">
            <img
              src={logoImages.tarc}
              alt="Shriram Park 63"
